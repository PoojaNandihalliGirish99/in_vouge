        ...
        <>
            ...
            <div className='flex justify-around items-center'>
                ...
                <div className='flex flex-row items-center'>
                    <button className='font-inter text-base font-medium tracking-normal leading-none text-center mr-6'>Logout</button>
                    <div className='flex flex-row items-center'>
                ...
                <div className='flex flex-row items-center cursor-pointer' onClick={() => handleOpen()}>
                    {totalAmount > 0 ? 
                    <span className='rounded-full bg-gray-300 px-2 text-inter text-sm mr-1'>{totalAmount}</span> : 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="#000" className="w-6 h-6">
            ...
            <div className='bg-black p-4 w-full flex justify-around'>
                ...
                <div className='text-white font-inter text-base font-medium tracking-normal leading-none text-center'>Free shipping with returns</div>
